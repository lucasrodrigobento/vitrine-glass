    ...
    private function seedLiderVidros(): void
    {
        ...
        $tenant = Tenant::updateOrCreate(
            ...
            [
                ...
                'cor_texto'        => '#6f7070',
                'cor_rodape_fundo' => '#000001',
                'cor_rodape_links' => '#000001',
                ...
                'google_ads_whatsapp_label'  => 'AW-666035862/whatsapp_click',
                ...
                'seo_title'       => 'Vidraçaria em Goiânia | Box Banheiro, Espelhos e Esquadrias de Alumínio — Líder Vidros',
                'seo_description' => 'Vidraçaria em Goiânia com mais de 7 anos instalando box de banheiro, espelhos e esquadrias de alumínio. Atendemos Aparecida de Goiânia, Senador Canedo e região. Orçamento: (62) 9 8300-4326.',
                'seo_keywords'    => 'vidraçaria goiânia, box banheiro goiânia, espelhos sob medida goiânia, esquadrias alumínio goiânia, fechamento sacada goiânia, box banheiro aparecida de goiânia, vidraçaria senador canedo, portas de vidro goiânia, espelhos goiânia',
                'hero_titulo'     => 'Vidraçaria em Goiânia',
                'hero_subtitulo'  => 'Box de banheiro, espelhos e esquadrias de alumínio com instalação garantida',
                'sobre_titulo'    => 'Líder Vidros',
                'sobre_descricao' => 'Fundada em Goiânia, a Líder Vidros tem mais de 7 anos instalando box de banheiro, espelhos sob medida e esquadrias de alumínio em residências e comércios da região. Desde o começo, o jeito de trabalhar é o mesmo: chegar no horário combinado, entregar o serviço certo e tratar o espaço do cliente com cuidado. A equipe é experiente e os materiais têm procedência garantida.',
                'sobre_missao'    => 'Entregar serviços de vidraçaria com pontualidade e honestidade, respeitando o prazo e o espaço de cada cliente.',
                'sobre_visao'     => 'Ser a vidraçaria mais indicada pelos próprios clientes em Goiânia e toda a região metropolitana.',
                'sobre_valores'   => 'Chegar no horário combinado, ser transparente no orçamento e cuidar do ambiente do cliente como se fosse nosso.',
                'logo_header'              => 'logo',
    ...
    private function seedBoxVidros(): void
    {
        ...
        $tenant = Tenant::updateOrCreate(
            ...
            [
                ...
                'google_ads_id'             => null,
                'google_analytics_id'       => null,
                'google_ads_whatsapp_label' => null,
                'google_maps_embed'         => null,
                'font_body'            => 'Open Sans',
                'font_heading'    => 'Righteous',
                'font_accent'     => 'Josefin Sans',
