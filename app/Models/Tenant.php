...
class Tenant extends Model
{
    protected $fillable = [
        ...
        'google_ads_id', 'google_analytics_id', 'google_ads_whatsapp_label',
        'google_maps_embed', 'schema_type',
    ...
    public function toConfigArray(): array
    {
        ...
        return [
            ...
            'google_ads_whatsapp_label'  => $this->google_ads_whatsapp_label,
            'google_maps_embed'          => $this->google_maps_embed,
            'google_maps_query' => $this->google_maps_query,
